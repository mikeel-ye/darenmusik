            ...
            try:
                await msg.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("</> ᴍᴜsɪᴄ ʙᴏᴛ", url=f"https://t.me/Alone_Dil_bot?startgroup=true"),
                            ],
                            [
                                InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ", url=link),
                                InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ", url=f"https://t.me/darensupport"),
                            ],
                        ]
                    )
                )
